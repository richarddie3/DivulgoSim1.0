// === SISTEMA DE SEGURANÇA ADICIONADO ===
        const SecuritySystem = {
            ...
            preventDevTools() {
                const devToolsCheck = setInterval(() => {
                    ...
                    if (widthThreshold || heightThreshold) {
                        document.body.innerHTML = '<div class="flex items-center justify-center min-h-screen bg-red-600 text-white text-xl">⚠️ Acesso não autorizado detectado</div>';
                ...
                const observer = new MutationObserver((mutations) => {
                    mutations.forEach((mutation) => {
                        if (mutation.type === 'attributes' && mutation.attributeName === 'src') {
                            SecuritySystem.reportIncident('Alteração de atributo suspeita detectada');
                        }
                    });
                });
            ...
            reportIncident(message) {
                console.warn('🚨 Incidente de Segurança:', message);
        ...
        // === VALIDAÇÃO DE INPUT SEGURA ADICIONADA ===
        ...
        const SecureCacheManager = {
            ...
            get(key) {
                try {
                    ...
                    console.warn('Recuperação de cache falhou:', error);
                    return null;
                }
            },
            remove(key) {
        ...
        const SocialProfileManager = {
            validateSocialUrl(platform, url) {
                ...
                if (patterns[platform] && !patterns[platform].test(url)) {
                    throw new Error(`URL do ${platform} inválida.`);
                }
        ...
        // === ESTADO DA APLICAÇÃO ORIGINAL COMPLETO ===
        const AppState = {
            auth: {
                currentUser: null
            },
            ...
            initializeDemoData() {
                // Eventos de demonstração COMPLETOS
                const demoEvents = [
                    {
                        id: 'event1',
                        ...
                        end_date: '2024-11-17',
                        description: 'O maior festival de música eletrônica do Brasil! Com DJs internacionais e nacionais, luzes incríveis e uma experiência única.',
                        organizer_id: 'org1',
                        is_public: true,
                    ...
                    },
                    {
                        ...
                        end_date: '2024-12-01',
                        description: 'Aprenda as melhores estratégias de marketing digital com especialistas do mercado. Inclui certificado.',
                        organizer_id: 'org1',
                        is_public: true,
                        image: 'https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
                        tickets: [
                            { id: 'ticket3', name: 'Lote Único', price: 120.00, quantity: 50 }
                        ],
                        category: 'Educação'
                    }
                ];
                ...
                // Tarefas de demonstração COMPLETAS
                const demoTasks = [
                    {
                        id: 'task1',
                        event_id: 'event1',
                        title: 'Post no Instagram',
                        description: 'Compartilhe o evento em seu feed com as hashtags #DivulgoSim #FestivalSP #MúsicaEletrônica',
                        deadline: '2024-11-10',
                        status: 'active',
                    ...
                    },
                    {
                        ...
                        description: 'Faça um story marcando o perfil do evento e usando o sticker de localização',
                        deadline: '2024-11-12',
                        status: 'active',
                        social_media: 'instagram',
                        task_type: 'story',
                ...
                const demoProfiles = {
                    'org1': {
                        ...
                        bio: 'Especialista em criar experiências memoráveis através de eventos únicos e bem organizados.',
                        ...
                        medicalInfo: {
                            ...
                            additionalNotes: 'Nenhuma observação adicional'
                        }
                    },
                    'div1': {
                        name: 'Maria Divulgadora',
                        title: 'Divulgadora Digital',
                        bio: 'Especialista em marketing digital e divulgação de eventos nas redes sociais.',
                        ...
                        medicalInfo: {
                            ...
                            additionalNotes: 'Controle médico regular'
                        }
                    }
                };
        ...
        // === SISTEMA DE AUTENTICAÇÃO ORIGINAL COMPLETO ===
        const AuthManager = {
            users: new Map(),
            init() {
                const demoUsers = [
            ...
            createDefaultProfile(user) {
                const defaultProfile = {
                    ...
                    bio: user.type === Constants.USER_TYPES.ORGANIZER 
                        ? 'Especialista em criar experiências memoráveis através de eventos únicos e bem organizados.'
                        : 'Especialista em marketing digital e divulgação de eventos nas redes sociais.',
                    email: user.email,
                    phone: '(00) 00000-0000',
                    profilePicture: null,
                    socialLinks: {},
                    ...
                    AppState.notifications = [
                        {
                            ...
                            message: 'Você foi convidado para divulgar o Festival de Música SP',
                            type: 'invite',
                            read: false,
        ...
        // === SISTEMA DE RECUPERAÇÃO DE SENHA ORIGINAL COMPLETO ===
        ...
        // === HELPERS REUTILIZÁVEIS ORIGINAIS COMPLETOS ===
        const FormatHelper = {
            date(dateString) {
                try {
        ...
        const EventManager = {
            ...
            toggleFollow(eventId) {
                if (AppState.followedEventIds.has(eventId)) {
                    ...
                    showAlert('Agora você está seguindo este evento!', 'success');
                }
                Renderer.renderApp();
            },
                            ...
                            <div class="event-card-actions">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    ${TemplateHelpers.condition(isFollowing && !showManageButtons, 
                                        '<span class="text-green-400 text-sm font-semibold">✓ Seguindo</span>'
                                    )}
                                </div>
                ...
                if (showFollowButton) {
                    return `
                        <button onclick="EventManager.toggleFollow('${event.id}')" class="event-card-button ${isFollowing ? 'following' : 'follow'}">
                            ${isFollowing ? '✓ Seguindo' : '+ Seguir Evento'}
                        </button>
                    `;
                }
                return `
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between items-start mb-2">
                                    ...
                                    <div class="flex gap-2">
                                        ${isCompleted ? 
                                            '<span class="bg-green-500 text-white px-2 py-1 rounded text-sm">Concluída</span>' : 
                                ...
                                <div class="mb-3">
                                    <div class="flex justify-between items-center mb-1">
                                        <span class="text-gray-300">Descrição:</span>
        ...
        const Renderer = {
                ...
                mainContent.innerHTML = `
                    <div class="max-w-6xl mx-auto">
                        <div class="text-center text-white mb-12">
                            <h2 class="text-4xl font-bold mb-4 font-['Poppins']">Descubra Eventos Incríveis</h2>
                            <p class="text-xl text-gray-300 mb-8">Conecte-se com organizadores e ajude a divulgar eventos que você ama</p>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 max-w-2xl mx-auto mb-8">
                                <h3 class="text-2xl font-bold mb-4 font-['Poppins']">🔍 Comece a Divulgar Hoje!</h3>
                ...
                mainContent.innerHTML = `
                    <div class="promoter-view-container">
                        <div class="promoter-header">
                            <h2 class="text-3xl font-bold text-white text-center font-['Poppins']">Área do Divulgador</h2>
                                ...
                                <div class="event-card" onclick="UI.showEventDetail('${event.id}')">
                                    ...
                                    <div class="event-card-content">
                                        ...
                                        <div class="event-card-info">
                                            ...
                                            <div class="mt-3">
                                                <span class="bg-blue-900 text-white px-3 py-1 rounded-full text-sm">
                                                    ${eventTasks.length} tarefas disponíveis
                                                </span>
                                            </div>
                                        </div>
                                        <div class="event-card-actions">
            ...
            renderEmptyState(type, userType = '') {
                const messages = {
                    ...
                    'eventos seguidos': {
                        divulgador: {
                            ...
                            action: 'Ver Eventos Disponíveis',
                    ...
                    'eventos favoritos': {
                        divulgador: {
                            ...
                            description: 'Adicione eventos aos favoritos para encontrá-los facilmente!',
                            action: 'Ver Eventos Disponíveis',
                            handler: 'UI.setPromoterView(\'events\')'
                        }
                    },
                ...
                return `
                    <div class="empty-state">
                        <div class="empty-state-icon">${type.includes('evento') ? '📅' : '🔍'}</div>
            ...
            renderPersonalInfo(profile) {
                ...
                return `
                    <div class="profile-section active">
                        <h3 class="text-2xl font-bold text-gray-800 mb-6 font-['Poppins']">Informações Pessoais</h3>
                        <div class="profile-grid">
                            <div class="profile-field">
                                <label>Nome Completo</label>
                                <div class="p-2 bg-gray-50 rounded">${personalInfo.fullName || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>Data de Nascimento</label>
                                <div class="p-2 bg-gray-50 rounded">${personalInfo.birthDate ? FormatHelper.date(personalInfo.birthDate) : 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>CPF</label>
                                <div class="p-2 bg-gray-50 rounded">${personalInfo.cpf || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>RG</label>
                                <div class="p-2 bg-gray-50 rounded">${personalInfo.rg || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>Gênero</label>
                                <div class="p-2 bg-gray-50 rounded">${personalInfo.gender || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>Estado Civil</label>
                                <div class="p-2 bg-gray-50 rounded">${personalInfo.maritalStatus || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>Email</label>
                                <div class="p-2 bg-gray-50 rounded">${profile.email || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>Telefone</label>
                                <div class="p-2 bg-gray-50 rounded">${profile.phone || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
            ...
            renderAddressInfo(profile) {
                ...
                return `
                    <div class="profile-section active">
                        <h3 class="text-2xl font-bold text-gray-800 mb-6 font-['Poppins']">Informações de Endereço</h3>
                        <div class="profile-grid">
                            <div class="profile-field">
                                <label>CEP</label>
                                <div class="p-2 bg-gray-50 rounded">${address.cep || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>Logradouro</label>
                                <div class="p-2 bg-gray-50 rounded">${address.street || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>Número</label>
                                <div class="p-2 bg-gray-50 rounded">${address.number || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>Complemento</label>
                                <div class="p-2 bg-gray-50 rounded">${address.complement || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>Bairro</label>
                                <div class="p-2 bg-gray-50 rounded">${address.neighborhood || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>Cidade</label>
                                <div class="p-2 bg-gray-50 rounded">${address.city || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>Estado</label>
                                <div class="p-2 bg-gray-50 rounded">${address.state || 'Não informado'}</div>
                            </div>
                            <div class="profile-field">
                                <label>País</label>
                                <div class="p-2 bg-gray-50 rounded">${address.country || 'Não informado'}</div>
                            </div>
                        </div>
                    </div>
                `;
                ...
                return `
                    <div class="profile-section active">
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <h4 class="font-semibold text-blue-900 mb-2">📊 Estatísticas do Perfil</h4>
            ...
            renderMedicalInfo(profile) {
                ...
                return `
                    <div class="profile-section active">
                        <h3 class="text-2xl font-bold text-gray-800 mb-6 font-['Poppins']">Informações para Primeiros Socorros</h3>
                        <div class="medical-card">
                            <h4><i class="fas fa-heartbeat"></i> Ficha Médica</h4>
                            <div class="medical-info">
                                <div class="medical-field">
                                    <strong>Tipo Sanguíneo</strong>
                                    <span>${medicalInfo.bloodType || 'Não informado'}</span>
                                </div>
                                <div class="medical-field">
                                ...
                                <div class="medical-field">
                                    ...
                                    <span>${emergencyContact.name || 'Não informado'} - ${emergencyContact.phone || ''} (${emergencyContact.relationship || ''})</span>
                                </div>
                                <div class="medical-field">
                                    <strong>Plano de Saúde</strong>
                                    <span>${medicalInfo.healthInsurance || 'Não informado'}</span>
                                </div>
                                <div class="medical-field">
                        ...
                        <div class="mt-4">
                            <button onclick="UI.generateMedicalCard()" class="btn btn-danger">
                                <i class="fas fa-file-medical"></i> Gerar Ficha Médica
                            </button>
                        </div>
                    </div>
                `;
        ...
        const UI = {
                        ...
                        <div class="bg-white rounded-xl p-8 max-w-md w-full">
                            ...
                            <form id="loginForm">
                                ...
                                <div class="mt-6 p-4 bg-gray-100 rounded-lg">
                                    <p class="text-sm text-gray-600 mb-2">Contas de demonstração:</p>
            ...
            showPasswordRecoveryModal() {
                ...
                form.addEventListener('submit', async (e) => {
                    ...
                    try {
                        ...
                        showAlert('Enviando email de recuperação...', 'info');
                            ...
                            <form id="resetPasswordForm">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="password" name="newPassword" required minlength="6" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:border-blue-900 focus:outline-none" placeholder="Mínimo 6 caracteres">
                                    </div>
                                    <div>
                        ...
                        <div class="bg-white rounded-xl p-8 max-w-md w-full">
                            ...
                            <form id="registerForm">
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        <label class="block text-gray-700 font-semibold mb-2">Senha</label>
                                        <input type="password" name="password" required minlength="6" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:border-blue-900 focus:outline-none" placeholder="Mínimo 6 caracteres">
                                    </div>
                                </div>
                                <div class="flex gap-4 mt-6">
                                    <button type="button" onclick="ModalHelper.close()" class="flex-1 btn btn-secondary">
                            ...
                            <form id="createEventForm">
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" name="name" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:border-blue-900 focus:outline-none" placeholder="Ex: Festival de Verão">
                                    </div>
                                    <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-gray-700 font-semibold mb-2">Data de Início</label>
                            ...
                            <div class="event-images-section">
                                ...
                                ${eventImages.length > 0 ? `
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="text-gray-600 text-sm">Clique no botão de download <i class="fas fa-download"></i> em qualquer imagem para baixá-la</p>
                                    </div>
                                ` : `
                                    ...
                                    ${taskSubmissions.map(({ task, submissions }) => `
                                        <div class="border rounded-lg p-4">
                                            ...
                                            ${submissions.length > 0 ? `
                                                <div class="mt-3">
                                                    <h6 class="font-medium mb-2">Submissões:</h6>
                                                    <div class="space-y-2">
                                                        ${submissions.map(submission => `
                                                            <div class="flex justify-between items-center p-2 bg-gray-50 rounded">
                                                                <div>
                                                                    <span class="font-medium">${submission.user_name}</span>
                                                                    <a href="${submission.link}" target="_blank" class="text-blue-600 hover:underline ml-2">Ver publicação</a>
                                                                </div>
                                            ...
                                            ` : '<p class="text-gray-500 text-sm">Nenhuma submissão ainda.</p>'}
                                        </div>
                                    `).join('')}
                                </div>
                            </div>
                    ...
                    <div class="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
                        <div class="bg-white rounded-xl p-8 max-w-md w-full max-h-[90vh] overflow-y-auto">
                            ...
                            <form id="createTaskForm">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label class="block text-gray-700 font-semibold mb-2">Título da Tarefa</label>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label class="block text-gray-700 font-semibold mb-2">Tipo de Conteúdo</label>
                    ...
                    <div class="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
                        <div class="bg-white rounded-xl p-8 max-w-md w-full">
                            ...
                            <form id="taskSubmissionForm">
                                <div class="mb-4">
                                    <label class="block text-gray-700 font-semibold mb-2">Link da Publicação</label>
                        ...
                        <div class="bg-white rounded-xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                            ...
                            <form id="editProfileForm">
                                <div class="space-y-6">
                                        ...
                                        <div class="profile-grid">
                                            ...
                                            <div class="profile-field">
                                                ...
                                                <select name="gender">
                                                    ...
                                                    <option value="Prefiro não informar" ${profile.personalInfo?.gender === 'Prefiro não informar' ? 'selected' : ''}>Prefiro não informar</option>
                                                </select>
                                            </div>
                                            <div class="profile-field">
                                                <label>Estado Civil</label>
                                                <select name="maritalStatus">
                                                    ...
                                                    <option value="Viúvo(a)" ${profile.personalInfo?.maritalStatus === 'Viúvo(a)' ? 'selected' : ''}>Viúvo(a)</option>
                                                </select>
                                            </div>
                                            <div class="profile-field">
                                                <label>Email *</label>
                                    ...
                                    <!-- Endereço -->
                                    <div class="border-b pb-4">
                                        <h4 class="text-xl font-bold text-blue-900 mb-4"><i class="fas fa-map-marker-alt"></i> Endereço</h4>
                                        <div class="profile-grid">
                                            <div class="profile-field">
                                                <label>CEP</label>
                                    ...
                                    <!-- Informações Médicas -->
                                    <div>
                                        <h4 class="text-xl font-bold text-blue-900 mb-4"><i class="fas fa-heartbeat"></i> Informações para Primeiros Socorros</h4>
                                        <div class="profile-grid">
                                            <div class="profile-field">
                                            ...
                                            <div class="profile-field">
                                                ...
                                                <textarea name="medications" placeholder="Liste medicamentos de uso contínuo...">${profile.medicalInfo?.medications || ''}</textarea>
                                            </div>
                                            <div class="profile-field">
                                                <label>Doenças Pré-existentes</label>
                                                <textarea name="conditions" placeholder="Liste doenças ou condições médicas...">${profile.medicalInfo?.conditions || ''}</textarea>
                                            </div>
                                            <div class="profile-field">
                                            ...
                                            <div class="profile-field">
                                                ...
                                                <input type="text" name="emergencyRelationship" value="${profile.medicalInfo?.emergencyContact?.relationship || ''}" placeholder="Ex: Pai, Mãe, Cônjuge...">
                                            </div>
                                            <div class="profile-field">
                                            ...
                                            <div class="profile-field">
                                                ...
                                                <textarea name="additionalNotes" placeholder="Outras informações médicas relevantes...">${profile.medicalInfo?.additionalNotes || ''}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            searchCEP(cep) {
                ...
                showAlert('Buscando informações do CEP...', 'info');
                ...
                setTimeout(() => {
                    ...
                    if (address) {
                        ...
                        showAlert('CEP não encontrado. Preencha os dados manualmente.', 'warning');
                    }
                }, 1000);
            },
                            ...
                            <div class="text-center mb-6">
                                <div class="relative inline-block">
                                    ...
                                    <div class="absolute inset-0 rounded-full bg-black/50 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
                                        <span class="text-white text-sm font-semibold">Prévia</span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-900 transition-colors">
                                            ...
                                            <div id="uploadArea" class="cursor-pointer">
                                                ...
                                                <p class="text-gray-500 text-sm mt-1">JPEG, PNG ou GIF (máx. 5MB)</p>
                                            </div>
                                        </div>
                    ...
                    <div class="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
                        <div class="bg-white rounded-xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                            ...
                            <div class="grid md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    <h4 class="text-lg font-semibold mb-2">Informações do Evento</h4>
                                    <div class="space-y-2">
                            ...
                            <!-- Seção de Imagens do Evento para Divulgadores -->
                            ${eventImages.length > 0 ? `
                                <div class="event-images-section">
                                    <div class="event-images-header">
                                        <h4 class="event-images-title">
                                        ...
                                        <p class="text-gray-600 text-sm">Baixe as imagens oficiais para usar em suas divulgações</p>
                                    </div>
                                    <div id="eventCarouselContainer"></div>
                                    <div class="mt-4 text-center">
                                        <p class="text-gray-600 text-sm">Clique no botão de download <i class="fas fa-download"></i> em qualquer imagem para baixá-la</p>
                            ...
                            <h4 class="text-lg font-semibold mb-4">Tarefas Disponíveis</h4>
                            <div class="space-y-4">
                                ${eventTasks.length > 0 ? 
                                    TemplateHelpers.loop(eventTasks, task => TaskTemplates.card(task, { showSubmission: true })) : 
                                    '<p class="text-gray-500">Nenhuma tarefa disponível para este evento.</p>'
                                }
                            </div>
                        </div>
                    </div>
                            ...
                            <form id="editEventForm">
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="category" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:border-blue-900 focus:outline-none">
                                            <option value="">Selecione uma categoria</option>
                                            <option value="Música" ${event.category === 'Música' ? 'selected' : ''}>Música</option>
                                            <option value="Educação" ${event.category === 'Educação' ? 'selected' : ''}>Educação</option>
            ...
            generateProfilePDF() {
                showAlert('Funcionalidade de exportação em PDF será implementada em breve!', 'info');
            },
            generateMedicalCard() {
                const user = AuthManager.getCurrentUser();
                const profile = AppState.userProfiles.get(user.id);
                ...
                const medicalCardHTML = `
                    <div class="bg-white p-6 rounded-lg shadow-lg max-w-md mx-auto">
                        <h3 class="text-xl font-bold text-red-600 mb-4 text-center">FICHA MÉDICA DE EMERGÊNCIA</h3>
                        <div class="space-y-3">
                            <div><strong>Nome:</strong> ${profile?.name || user.name}</div>
                            <div><strong>Tipo Sanguíneo:</strong> ${medicalInfo.bloodType || 'Não informado'}</div>
                            ...
                            <div><strong>Condições Médicas:</strong> ${medicalInfo.conditions || 'Nenhuma'}</div>
                            <div><strong>Contato de Emergência:</strong> ${emergencyContact.name || 'Não informado'} - ${emergencyContact.phone || ''}</div>
                            <div><strong>Parentesco:</strong> ${emergencyContact.relationship || ''}</div>
                            <div><strong>Plano de Saúde:</strong> ${medicalInfo.healthInsurance || 'Não informado'}</div>
                        </div>
                        <div class="mt-4 text-xs text-gray-500 text-center">
                            Esta informação deve é usada apenas em situações de emergência médica.
                        </div>
                    </div>
                `;
                const modal = ModalHelper.open(`
                    <div class="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
                        <div class="bg-white rounded-xl p-8 max-w-md w-full">
                            <div class="flex justify-between items-center mb-6">
                                <h3 class="text-2xl font-bold text-blue-900">Ficha Médica</h3>
                                <button onclick="ModalHelper.close()" class="text-gray-500 hover:text-gray-700">
                                    <i class="fas fa-times text-xl"></i>
                                </button>
                            </div>
        ...
        // === SISTEMA DE NOTIFICAÇÕES ORIGINAL COMPLETO ===
                ...
                if (notifications.length === 0) {
                    dropdown.innerHTML = `
                        <div class="notification-item">
                            <div class="notification-message text-center py-4">Nenhuma notificação</div>
                        </div>
                    `;
                } else {
        ...
        const ProfileManager = {
            openProfile() {
                if (!AuthManager.isLoggedIn()) {
                    showAlert('Você precisa estar logado para acessar o perfil', 'warning');
                    return;
                }
        ...
        const ImageUploader = {
            ...
            async handleImageUpload(imageFile, defaultImage) {
                ...
                try {
                    ...
                    showAlert('Erro no upload da imagem. Usando imagem padrão.', 'warning');
                    return defaultImage;
                }
            }
        };
        ...
        function initApp() {
            // Iniciar sistemas de segurança primeiro
            SecuritySystem.init();
            
            // Inicializar dados e autenticação
